...
public class RecyclerViewAdapter1 extends RecyclerView.Adapter<RecyclerViewHolders1> {

    public static List<ItemObject> itemList;

    private View layoutView;

    public RecyclerViewAdapter1() {
    }

    public RecyclerViewAdapter1(List<ItemObject> itemLists) {
        itemList = itemLists;
    }
    ...
    @Override
    public RecyclerViewHolders1 onCreateViewHolder(ViewGroup parent, int viewType) {

//        if (viewType == 1)
            layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.cell_list_calendar, null);

        return new RecyclerViewHolders1(layoutView);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewHolders1 holder, int position) {//final int position
...
class RecyclerViewHolders1 extends RecyclerView.ViewHolder {
    ...
    RecyclerViewHolders1(View itemView) {
        super(itemView);
